...
During the [Penance](../../history.md#age-of-spring), Tek not only protected its jungle from nix, it used its immense root system to lift a significant portion of the terrain. Slow and deliberate, it dragged the plateau toward the [Fesh Peninsula](../../isolas/fesh_peninsula/index.md), creating the plateau that stands now between the Punika<!-- TODO. Link. --> and the Puneui mountain ridges<!-- TODO. Link. -->.
