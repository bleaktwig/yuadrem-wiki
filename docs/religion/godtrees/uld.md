...
Uld was a purple kapok tree of breathtaking scale, whose purple crown shaded the entirety of the Everwoods<!--TODO:LINK--->, and turned its center into a swamp known as the Pale Blemish<!--TODO:LINK--->. While the god-tree didn't produce any progeny, it befriended a band of wandering [oths](../../kins/oth.md), who established the city-state of Ignelli<!--TODO:LINK---> on the labyrinthian passageways created by Uld's trunk and roots.
