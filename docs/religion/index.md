...
![The Cosmos](img/cosmos.y796_v100_dpi300.png)<br />{: .center}
_A first glance into the Cosmos and its relation to the goddesses and gods of Tanethism, 796 A.S.. Each of the divinities that inhabits the heavens is presented around Darhoc and the Ring of Color that surrounds it. Recorded by the Fremite Monastery of Chist._{: .center}
...
![Etian signature of Relas](illuminants/img/relas.png)<br />{: .center}
...
![Etian signature of Laver](illuminants/img/laver.png)<br />{: .center}
...
![Etian signature of Bades](illuminants/img/bades.png)<br />{: .center}
...
![Etian signature of Rerisi](illuminants/img/rerisi.png)<br />{: .center}
...
![Etian signature of Tinos](illuminants/img/tinos.png)<br />{: .center}
