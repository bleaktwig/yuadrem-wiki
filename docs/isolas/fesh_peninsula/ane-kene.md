# Ane-Kene
Ane-kene is the sociological agreement proposed by the [Febrid](../../religion/mevic_gods/febrid.md) temple in Ferames<!-- TODO. Link. -->. The system has seen wide adoption in the Sumi of Ushpavam<!-- TODO. Link. -->, and is spreading thorough the [Fesh Peninsula](index.md).
...
* **Wese**, which is the clean drink needed for the survival of the ivu. Both yalu and wese are part of the domain of [Matevos](../../religion/mevic_gods/matevos.md).
...
* **Pali** is the degree of self-sufficiency of a bulu. Most bulus have a strong pali, but it is common for some to be weaker in this regard, with the obvious example of nomadic bulus. The pali is part of the domain of [Vahan](../../religion/mevic_gods/vahan.md).
...
* **Bete** is the responsibility of the bulu to provide healthcare for the ivus. Both kudu and bete are the domain of [Bagrat](../../religion/mevic_gods/bagrat.md).
...
* **Sibi** stands for all things that concern the production, use, and distribution of things in the bulu. It should provide for the needs of the ivu, including the taka. Both the ganu and sibi are the domain of [Febrid](../../religion/mevic_gods/febrid.md).

**Fasi**. The kudu, ganu, sibi, and bete of a bulu should be able to provide for all ivus that live in it. In addition, they should maintain a surplus of around a sixth of their consumption. This surplus is known as fasi, and is offered to travelers and visiting nomadic bulus. Fasi is part of the domain of [Zash](../../religion/damic_gods/zash.md).
...
**Mafa.** While bulus should be self-sufficient, this doesn't mean that they're to be resilient to the worst emergencies -- no one is. In the case of a natural disaster, a threat from outsiders, or a nix tide, at least one emergency cache should be available to each buda. This is the mafa, and is part of the domain of [Vahan](../../religion/mevic_gods/vahan.md).
...
The godess [Fusine](../../religion/mevic_gods/fusine.md) is associated to the resolution of all conflicts, but is particularly venerated in the yaka.
