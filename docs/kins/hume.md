...
The kulbaba were the second to emigrate, and settled on the tropical islands of the Qul Archipelago<!--TODO:LINK--->. On it, they separated into a myriad of chiefdoms, claiming the islands and many of the nearby territories. While they never achieved full cooperation between chiefs, they became known as the Jenkash Empire<!--TODO:LINK---> due to their constant expansion. Most of the kulbaba arrived in the Fesh Peninsula along with the [elves](elf.md) in the [Landing of Drejek](../history.md#age-of-sap), while most of the Dentralin Chiefdom<!--TODO:LINK---> immigrated earlier among the bughna, establishing temples in the Sumi of Fremit<!--TODO:LINK---> and the Saefel Canyon<!--TODO:LINK--->.
